 ...
 *
 * @package WordPress
 * @subpackage AB_Portfolio
 * @since AB_Portfolio 1.0
 *
 */
get_header();
?>
...
<main class="drake-main">
  <div id="smooth-wrapper">
    <div id="smooth-content">
        ...
        <div class="custom-container">
          <div class="hero-content content-width">
            ...
            <a
              ...
              <img src="<?php bloginfo('template_directory'); ?>/assets/images/round-text.png" alt="" />
              <i class="las la-arrow-down"></i>
            </a>

            <div class="facts d-flex">
              <div
                class="left scroll-animation"
                data-animation="fade_from_left">
                <h1>10+</h1>
                <p>Years of <br />Experience</p>
              </div>
              <div
                class="right scroll-animation"
      ...
      <section class="about-area page-section scroll-to-page" id="about">
        <div class="custom-container">
          <div class="about-content content-width">
            <div class="section-header">
              <h4
                class="subtitle scroll-animation sfx"
                data-animation="fade_from_bottom">
      ...
      <section
        class="services-area page-section scroll-to-page"
        id="services">
        <div class="custom-container">
          <div class="services-content content-width">
            ...
            <div class="services-items">
              <div
                class="service-item scroll-animation"
                data-animation="fade_from_bottom">
        ...
        <div class="custom-container">
          <div class="skills-content content-width">
            ...
            <div class="row skills text-center">
              <div
                class="col-md-3 scroll-animation"
                data-animation="fade_from_left">
                <div class="skill">
                  <div class="skill-inner">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/figma.png" alt="Figma" />
              ...
              <div
                ...
                <div class="skill">
                  <div class="skill-inner">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/framer.png" alt="Framer" />
              ...
              <div
                ...
                <div class="skill">
                  <div class="skill-inner">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/webflow.png" alt="Webflow" />
              ...
              <div
                ...
                <div class="skill">
                  <div class="skill-inner">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/react.png" alt="React" />
              ...
              <div
                ...
                <div class="skill">
                  <div class="skill-inner">
                    <img
                      src="<?php bloginfo('template_directory'); ?>/assets/images/wordpress.png"
                      alt="WordPress" />
              ...
              <div
                ...
                <div class="skill">
                  <div class="skill-inner">
                    <img
                      src="<?php bloginfo('template_directory'); ?>/assets/images/laravel.png"
                      alt="Laravel/PHP" />
      ...
      <section
        class="portfolio-area page-section scroll-to-page"
        id="portfolio">
        <div class="custom-container">
            ...
            <div class="row portfolio-items">
              <div
                ...
                <div class="portfolio-item portfolio-full">
                  <div class="portfolio-item-inner">
                    <a
                      href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio1.jpg"
                      data-lightbox="example-1">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio1.jpg"
                        alt="Portfolio" />
                    </a>
              ...
              <div
                ...
                <div class="portfolio-item portfolio-half">
                  <div class="portfolio-item-inner">
                    <a
                      href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio2.jpg"
                      data-lightbox="example-1">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio2.jpg"
                        alt="Portfolio" />
                    </a>
              ...
              <div
                ...
                <div class="portfolio-item portfolio-half">
                  <div class="portfolio-item-inner">
                    <a
                      href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio3.jpg"
                      data-lightbox="example-1">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio3.jpg"
                        alt="Portfolio" />
                    </a>
              ...
              <div
                ...
                <div class="portfolio-item portfolio-half">
                  <div class="portfolio-item-inner">
                    <a
                      href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio4.jpg"
                      data-lightbox="example-1">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio4.jpg"
                        alt="Portfolio" />
                    </a>
              ...
              <div
                ...
                <div class="portfolio-item portfolio-half">
                  <div class="portfolio-item-inner">
                    <a
                      href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio5.jpg"
                      data-lightbox="example-1">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio5.jpg"
                        alt="Portfolio" />
                    </a>
      ...
      <section
        class="testimonial-area page-section scroll-to-page"
        id="testimonial">
        <div class="custom-container">
          <div class="testimonial-content content-width">
            <div class="section-header">
              <h4
                class="subtitle scroll-animation sfx mt-3"
                data-animation="fade_from_bottom">
            ...
            <div
              class="testimonial-slider-wrap scroll-animation"
              data-animation="fade_from_bottom">
              <div class="owl-carousel testimonial-slider owl-theme">
                <div class="testimonial-item">
                  <div class="testimonial-item-inner">
                    <div class="author d-flex align-items-center">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/testimonial-1.jpg"
                        alt="testinomial" />
                      <div class="right">
                        <h3>Paublo Dybala</h3>
                        <p class="designation">
                    ...
                    <p>
                      “Drake - A Developer with the creativity, professional
                ...
                <div class="testimonial-item">
                  <div class="testimonial-item-inner">
                    <div class="author d-flex align-items-center">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/testimonial-2.jpg"
                        alt="testinomial" />
                      <div class="right">
                ...
                <div class="testimonial-item">
                  <div class="testimonial-item-inner">
                    <div class="author d-flex align-items-center">
                      <img
                        src="<?php bloginfo('template_directory'); ?>/assets/images/testimonial-3.jpg"
                        alt="testinomial" />
                      <div class="right">
                        <h3>Phil Foden</h3>
                        <p class="designation">
            ...
            <div class="clients-logos">
              ...
              <div class="row align-items-center">
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_left">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-1.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_bottom">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-2.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_top">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-3.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_right">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-4.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_left">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-5.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_bottom">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-6.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_top">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-7.png" alt="client" />
                </div>
                <div
                  class="col-md-3 scroll-animation"
                  data-animation="fade_from_right">
                  <img src="<?php bloginfo('template_directory'); ?>/assets/images/client-8.png" alt="client" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section
        class="pricing-area page-section scroll-to-page"
        id="pricing">
        <div class="custom-container">
      ...
      <section class="contact-area page-section scroll-content" id="contact">
        <div class="custom-container">
          <div class="contact-content content-width contact-bg">
            <div class="section-header">
              <h4
                class="subtitle scroll-animation sfx"
                data-animation="fade_from_bottom">
            ...
            <form
              class="contact-form scroll-animation"
              data-animation="fade_from_bottom"
              method="POST"
